...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/nabilulilalbab/panelgrnwtf/main/config/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/nabilulilalbab/panelgrnwtf/main/config/vps.conf"
